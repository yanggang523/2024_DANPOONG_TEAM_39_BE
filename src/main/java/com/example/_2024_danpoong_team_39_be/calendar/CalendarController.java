...
//import com.example._2024_danpoong_team_39_be.login.dto.CareAssignmentDTO;
...
//            throw new IllegalArgumentException("careAssignmentId must not be null");
//        }
//
//        // CareAssignment 조회
...
//
//        // Calendar 저장
//        return calendarService.createCalendarForAssignment(careAssignmentId, calendar);
//    }
...
//            System.out.println("전송된 이메일: " + calendar.getCareAssignment().getMember().getEmail());
//
//            // 이메일이 일치하는지 확인
//            String loggedInUserEmail = principal.getName(); // 로그인한 사용자의 이메일
//
//            if (!loggedInUserEmail.equals(calendar.getCareAssignment().getMember().getEmail())) {
//                // 이메일이 일치하지 않으면 권한 없음 처리
//                System.out.println(principal.getName());  // principal 수정됨
//                System.out.println(calendar.getCareAssignment().getMember().getEmail());
...
//            }
//            if (calendar.getCareAssignment() == null || calendar.getCareAssignment().getMember().getEmail() == null) {
//                System.out.println(principal.getName());  // principal 수정됨
//                System.out.println(calendar.getCareAssignment().getMember().getEmail());
...
//            System.out.println("addEvent 메서드 호출됨");
//            System.out.println("로그인 사용자: " + principal.getName());  // principal 수정됨
//            System.out.println("전송된 이메일: " + updatedCalendar.getCareAssignment().getMember().getEmail());
//
//            // 이메일이 일치하는지 확인
//            String loggedInUserEmail = principal.getName(); // 로그인한 사용자의 이메일
//
//            if (!loggedInUserEmail.equals(updatedCalendar.getCareAssignment().getMember().getEmail())) {
//                // 이메일이 일치하지 않으면 권한 없음 처리
//                System.out.println(principal.getName());  // principal 수정됨
//                System.out.println(updatedCalendar.getCareAssignment().getMember().getEmail());
//                return ResponseEntity.status(HttpStatus.FORBIDDEN).body(null);
//            }
//            System.out.println("addEvent 메서드 호출됨");
//            System.out.println("로그인 사용자: " + principal.getName());  // principal 수정됨
...
//    }
//@PostMapping("/create")
//public ResponseEntity<CareAssignment> createCareAssignment(@RequestBody CareAssignmentDTO careAssignmentDTO) {
//    CareAssignment careAssignment = careAssignmentService.createCareAssignmentAndCalendar(careAssignmentDTO);
//    return ResponseEntity.ok(careAssignment);
//}
